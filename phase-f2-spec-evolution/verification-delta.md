...
> **`[HISTORICAL — pass-9 snapshot, SUPERSEDED (P13-004 annotation)]`** *The '6 VP-HOOK (024–029) + 25 VP-SKILL / grand total 31' figure below is a pass-9-era snapshot and MUST NOT be read as the current total. The CURRENT grand total is **VP-HOOK 024–032 (9 hooks) + 26 VP-SKILL = 35 VPs** (see §2 Totals / the v1.16 closing snapshot). VP-HOOK grew 029→032 across passes 10–12 (VP-HOOK-030 STEP 1a, VP-HOOK-031 human-comment path, VP-HOOK-032 O7 command_pattern) and VP-SKILL 074→075 (VP-SKILL-075 operator-boundary cron-exit).*
...
> is **6 VP-HOOK (024–029) + 25 VP-SKILL** (grand total 31 correct *for pass-9; SUPERSEDED — current is 9 hook / 26 skill / 35 total per the banner above*); corrected to **6 hook / 25 skill**. And the
...
UPDATED in place (no new VP id)**).** Each
...
+SM-52/+SM-53 (SM-50/SM-51 remain valid)**).
...
UPDATED v1.16 so it issues NO autonomous comment marker for any disposition (MARKDOWN_COMMENT_PATH eliminated, P13-001)**), **26 skill properties**
...
rows). P13-004 (historical-total annotation) and the PRISMDEMO sweep add no mutant.** All 47
...
**New mutation vector count: 47 (SM-9 … SM-53; SM-32 = SM-32a + SM-32b + SM-32-ext as of v1.9; SM-32a re-targeted + SM-32-ext kill vector re-worded at v1.10; +SM-38/SM-39/SM-40 at v1.10; +SM-41/SM-42 at v1.11; +SM-43 at v1.12; +SM-44/SM-45 at v1.13; +SM-46/SM-47 at v1.14; +SM-48/SM-49/SM-50/SM-51 at v1.15; +SM-52/SM-53 at v1.16).** SM-9..SM-16,
...
**Estimated new BATS test cases: ~258** (hooks/skills/integration; was ~243 at v1.15) + **~102 parity (.ps1)**
additions ≈ **~360 new test cases** for the cycle (was ~342). The **v1.16 pass-13 remediation** is a net **+15 BATS**,
...
+ strict parse-grammar vectors, P13-003)**)
and the SM-N catalog (SM-9..SM-53, **47 mutants** with SM-32 = SM-32a + SM-32b + SM-32-ext; +SM-38/SM-39/SM-40 at v1.10; +SM-41/SM-42 at v1.11; +SM-43 at v1.12; +SM-44/SM-45 at v1.13; +SM-46/SM-47 at v1.14; +SM-48/SM-49/SM-50/SM-51 at v1.15; **+SM-52/SM-53 at v1.16**).
...
*F2 Verification Delta v1.16 complete. **35 VPs** (0 collisions, 0 renumbering; VP count UNCHANGED — VP-HOOK-031 UPDATED
