...
| **BC-5.01.001 (v1.11)** *(NEW v1.3)* | VP-SKILL-069 | 4 — org_slug{static Iron-Law WHERE-clause on Stage-3 OCSF + temporal-adjacency blocks=2, DTU org-a-returns-zero-org-b/c=1, unscoped-query rejected=1} | ~1 | investigate-event PrismQL scoping (ADV-F2-P3-004); mostly static SKILL.md content assertion |
