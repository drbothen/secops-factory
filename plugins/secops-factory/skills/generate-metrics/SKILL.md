...
3. **Jira pass**: run the jr queries for the selected categories; changelog-based metrics fetch in the background with resumable guards (pattern in `data/effort-analysis-method.md` §2.1)
