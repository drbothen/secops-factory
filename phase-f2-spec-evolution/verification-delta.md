...
mutant → SM-40; v1.11's SM-P8-A/B → SM-41/42, all next-free).** Each VP-SKILL-050..074 and
VP-HOOK-024..029 appears in exactly one *owning* BC.
...
and VP-HOOK-024 EXTENDED with the P8-002 quote-aware vector/mutant**).
...
**New mutation vector count: 36 (SM-9 … SM-42; SM-32 = SM-32a + SM-32b + SM-32-ext as of v1.9; SM-32a re-targeted + SM-32-ext kill vector re-worded at v1.10; +SM-38/SM-39/SM-40 at v1.10; +SM-41/SM-42 at v1.11).** SM-9..SM-16,
...
With SM-9..SM-16 + SM-21..SM-22 + SM-28 + SM-29..SM-30 + **SM-31, SM-32a, SM-32b, SM-32-ext, SM-33..SM-42**
KILLED, the marker/authorization path meets the **≥95% require-review** target (SM-31/32a/32b/32-ext/33/34/38/39/41
land squarely on the disposition-guard emitter authorization boundary; SM-35/36/37/40/42 on the require-review
...
No corrections alter any invariant, EC, or postcondition semantics (the P7-002 / P8-003 stale-EC propagation
is a PO-owned text alignment, not a semantic change). All delta BCs are otherwise
internally consistent with the finalized **31-VP** set (VP-SKILL 001–074, VP-HOOK 024–029; v1.10/v1.11 add no
new VP — VP-HOOK-029 extended in place, VP-HOOK-024 / VP-SKILL-074 extended)
and the SM-N catalog (SM-9..SM-42, **36 mutants** with SM-32 = SM-32a + SM-32b + SM-32-ext; +SM-38/SM-39/SM-40 at v1.10; +SM-41/SM-42 at v1.11).
...
*F2 Verification Delta v1.11 complete. **31 VPs** (0 collisions, 0 renumbering): VP-SKILL 001–074,
